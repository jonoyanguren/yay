...
ALTER TABLE retreats ADD COLUMN IF NOT EXISTS reservation_deposit_cents INTEGER NOT NULL DEFAULT 60000;
ALTER TABLE retreats ADD COLUMN IF NOT EXISTS charge_full_amount BOOLEAN NOT NULL DEFAULT false;
